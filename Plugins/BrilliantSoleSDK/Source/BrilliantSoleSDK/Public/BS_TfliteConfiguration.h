...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "BS Tflite Configuration", meta = (ToolTip = "(only for 'Classification' tasks) - omit the first 'Idle' classification"))
