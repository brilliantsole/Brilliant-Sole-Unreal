...
bool UBS_BatteryManager::OnRxMessage(EBS_TxRxMessage MessageType, const TArrayView<const uint8> &Message)
{
    switch (MessageType)
    {
...
void UBS_BatteryManager::ParseBatteryCurrent(const TArrayView<const uint8> &Message)
{
